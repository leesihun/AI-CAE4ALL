...
Canonical example:
[`configs/Neural_Operator/deterministic/ex1/baseline/config_train_point_deeponet.txt`](../../configs/Neural_Operator/deterministic/ex1/baseline/config_train_point_deeponet.txt).
