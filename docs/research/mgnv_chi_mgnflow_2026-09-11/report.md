...
| [Production configs](../../../configs/HI_MGNFlow/SAOI_run/config_train_bot.txt) and [MGN-V counterpart](../../../configs/MeshGraphNets_Variational/SAOI_run/config_train_bot.txt) | Static displacement output, three input-only condition channels, augmentation, hierarchy, and training settings |
