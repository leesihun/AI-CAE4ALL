...
Same path and behavior as MeshGraphNets' general_modules/positional_features.py
(IMPLEMENTATION_PLAN.md section 4): these features are computed purely from
mesh topology and reference geometry, so they carry over unmodified.
"""
