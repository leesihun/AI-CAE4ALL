...
# (configs/campaigns/benchmarks_all/roster.tsv): the same 42 arms train_all.sh trains --
# a complete 7-model x 6-dataset grid as of 2026-08-24. Requires checkpoints
# already produced by configs/campaigns/benchmarks_all/train_all.sh (or equivalent) at
...
# configs/campaigns/benchmarks_all/score_rollouts.py then reads.
#
...
#
# Usage:
#   bash configs/campaigns/benchmarks_all/infer_all.sh
#   LABELS="meshgraphnets_ex8 transolver_ex8" bash configs/campaigns/benchmarks_all/infer_all.sh
#
# Then: python configs/campaigns/benchmarks_all/score_rollouts.py
