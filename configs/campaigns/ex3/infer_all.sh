...
# configs/campaigns/ex3/train_all.sh (must match exactly, so every checkpoint that gets
...
# configs/campaigns/ex3/train_all.sh (or equivalent).
#
# GPU assignment mirrors configs/campaigns/ex3/train_all.sh: Point-DeepONet, DeepONet,
...
#
# Usage:
#   bash configs/campaigns/ex3/infer_all.sh
#   METHODS="himgn-as-is himgn-p12" bash configs/campaigns/ex3/infer_all.sh
