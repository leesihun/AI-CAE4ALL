...
# configs/campaigns/ex3/generate_full_configs.py):
...
#
# Examples:
#   bash configs/campaigns/ex3/train_all.sh
#   CHECK_ONLY=1 bash configs/campaigns/ex3/train_all.sh
#   GPUS="0 1 2 3" bash configs/campaigns/ex3/train_all.sh
...
if [ "$rc" = "0" ]; then
    echo "Next: bash configs/campaigns/ex3/infer_all.sh"
fi
exit "$rc"
