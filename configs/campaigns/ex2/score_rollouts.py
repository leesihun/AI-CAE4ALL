...
Usage:
    ...
    python configs/campaigns/ex2/score_rollouts.py --methods meshgraphnets-hi transolver
    python configs/campaigns/ex2/score_rollouts.py --csv output/ex2_head_to_head/scores.csv
"""
...
# method label -> rollout directory, mirroring configs/campaigns/ex2/infer_all.sh.
ROLLOUT_DIRS = {
...
def main():
    ...
    if not all_rows:
        print("\nNo rollouts scored. Run configs/campaigns/ex2/infer_all.sh first.")
        return
