...
#
# Examples:
#   bash configs/campaigns/ex2/train_all.sh
#   CHECK_ONLY=1 bash configs/campaigns/ex2/train_all.sh
#   GPUS="0 1 2 3" bash configs/campaigns/ex2/train_all.sh
...
if [ "$rc" = "0" ]; then
    echo "Next: bash configs/campaigns/ex2/infer_all.sh"
fi
exit "$rc"
