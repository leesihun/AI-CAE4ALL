...
#   nohup bash configs/MeshGraphNets_Variational/SAOI_all_input/run_sweep.sh > run_sweep.out 2>&1 &
...
#
# Usage:
#   bash configs/MeshGraphNets_Variational/SAOI_all_input/run_sweep.sh
...
CFG_DIR="configs/MeshGraphNets_Variational/SAOI_all_input"
