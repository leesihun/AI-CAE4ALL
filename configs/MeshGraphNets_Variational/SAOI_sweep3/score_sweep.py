#!/usr/bin/env python
"""Score every arm of the SAOI wave-3 sweep into ONE report.
...
Usage:
    python configs/MeshGraphNets_Variational/SAOI_sweep3/score_sweep.py
...
def main():
    ...
    for arm in args.arms:
        ...
        row.update({
            ...
            "z_conditioning": cfg.get("z_conditioning"),
            "prior_grad_to_encoder": cfg.get("prior_grad_to_encoder"),
