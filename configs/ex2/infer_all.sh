...
#   LOG_ROOT = directory for transcript logs (default: output/ex2_head_to_head/infer_logs)
#
# Usage:
#   bash configs/ex2/infer_all.sh
#   METHODS="meshgraphnets meshgraphnets-hi" bash configs/ex2/infer_all.sh
...
LOG_ROOT="${LOG_ROOT:-output/ex2_head_to_head/infer_logs}"
