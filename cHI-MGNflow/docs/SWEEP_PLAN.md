...
```
configs/cHI-MGNflow/wave0/config_wave0_det.txt     결정론 HI-MGN
configs/cHI-MGNflow/wave0/config_wave0_flow.txt    cHI-MGNflow
                                                   ← 백본·데이터·예산 동일
...
python cHI-MGNflow/misc/wave0_report.py --det det.log --flow flow.log
python cHI-MGNflow/misc/eval_prediction_modes.py --config .../config_wave0_flow.txt
```
