...
answers and edits grounded in the live code and this file, not
...
decisions and their rationale; when they and the code disagree, the code is
authoritative for *current* behavior, but treat a mismatch as something to
reconcile (update whichever side is stale), not something to ignore.
