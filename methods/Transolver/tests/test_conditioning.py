...
from training_profiles.training_loop import _as_list  # noqa: E402
...
def test_scalar_test_batch_index_is_normalized_for_native_membership_checks():
    assert _as_list(0) == [0]
    assert _as_list([0, 2]) == [0, 2]
