...
Mirrors ``methods/SDFFlow/training_profiles/train_pipeline.py``: per-stage
...
def train_pipeline(config, config_filename='config.txt'):
    ...
    vae_path = vae_config.get('vae_modelpath', '../../output/simulgenvae/simulgenvae_vae.pth')
    lc_path = lc_config.get('lc_modelpath', '../../output/simulgenvae/simulgenvae_lc.pth')
